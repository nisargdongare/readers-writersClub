...
function createData(name, studentId, deviceId) {
  return { name, studentId, deviceId };
}

const rows = [
  createData("Nisarg", 305, 3.7),
  createData("Pavan", 452, 25.0),
  createData("Amruta", 262, 16.0),
  createData("JiJa", 159, 6.0)
];
...
const headCells = [
  ...
  { id: "deviceId", numeric: false, disablePadding: false, label: "deviceId" }
];
    ...
    >
      {numSelected > 0 ? (
        ...
        <Typography
          ...
          component="div"
        >
          Student And Device Connection List
        </Typography>
      )}
